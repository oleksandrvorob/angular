...
const ONLY_TEL_NUMBER_CONTROL_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => OnlyTelNumberDirective),
    multi: true
};

@Directive({
    selector: '[onlyTelNumber]',
    providers: [ONLY_TEL_NUMBER_CONTROL_VALUE_ACCESSOR]
})
export class OnlyTelNumberDirective implements ControlValueAccessor {
